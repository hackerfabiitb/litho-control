...
| --- | --- | --- | --- |
| 2026-09-26 | xyz_stage | Limit switches checked by hand with `xyz_stage/limit_switches.py`: X → D9, Y → D10, Z → D11, normally open to GND, all switching cleanly (D12 unused). [Details](xyz_stage/README.md#2026-09-26--limit-switches-checked-by-hand--working) | working; nothing acts on them yet (no homing or stop) |
